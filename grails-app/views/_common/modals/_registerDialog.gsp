<div class="modal hide" id="RegisterModal">
	...
	<div class="modal-body">
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span3 registration" name="firstName" id="firstName" placeholder="${message(code: 'security.firstname.label', default: 'Firstname')}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="lastName">${message(code: 'security.lastname.label', default: 'Lastname')}</label>
			<div class="controls">
				<input type="text" class="span3 registration" name="lastName" id="lastName" placeholder="${message(code: 'security.lastname.label', default: 'Lastname')}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="email">${message(code: 'security.email.label', default: 'Email')}</label>
			<div class="controls">
				<input type="text" class="span3 registration" name="email" id="email" placeholder="${message(code: 'security.email.label', default: 'Email')}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="password1">${message(code: 'security.password.label', default: 'Password')}</label>
			<div class="controls">
				<input type="password" class="span3 registration" name="password" id="password1" placeholder="${message(code: 'security.password.label', default: 'Password')}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="password2">${message(code: 'security.password.confirm.label', default: 'Confirm')}</label>
			<div class="controls">
				<input type="password" class="span3 registration" name="password2" id="password2" placeholder="${message(code: 'security.password.confirm.label', default: 'Confirm')}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="secretQuestion">${message(code: 'security.question.label', default: 'Secret question')}</label>
			<div class="controls">
				<input type="text" class="span3 registration" name="secretQuestion" id="secretQuestion" placeholder="${message(code: 'security.question.label', default: 'Secret question')}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="secretAnswer">${message(code: 'security.answer.label', default: 'Secret answer')}</label>
			<div class="controls">
				<input type="text" class="span3 registration" name="secretAnswer" id="secretAnswer" placeholder="${message(code: 'security.answer.label', default: 'Secret answer')}">
			</div>
		</div>
		<div class="control-group">
