...
class FacebookUserController {
	...
	/**
	 * Synchronize facebook user
	 * It saves the new user or connects it if already existing 
	 * @return
	 */
	def syncFacebookUser() { 
		...
		//send result to view syncFacebookUser		
		return [isLoggedWithFacebook : true, JSESSIONID : session.getId()];
